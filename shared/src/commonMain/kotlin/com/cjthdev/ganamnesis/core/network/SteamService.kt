...
class SteamService(private val client: HttpClient) {
    private val baseUrl = "https://api.steampowered.com"

    suspend fun getOwnedGames(apiKey: String, steamId: String): List<SteamGameDto> {
        val response: SteamOwnedGamesResponseWrapper = client.get("$baseUrl/IPlayerService/GetOwnedGames/v1/") {
